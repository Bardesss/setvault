...
from setvault_web.api import catalog_admin as catalog_admin_api
...
from setvault_web.api import images as images_api
...
def create_app() -> FastAPI:
    ...
    app.include_router(catalog_admin_api.router)
